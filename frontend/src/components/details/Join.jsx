            ...
            <CardActionArea>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  ...
                  <Typography>
                    <strong>.</strong> Positive Public Relations and Brand Image
                  </Typography>
                </Typography>
              </CardContent>
          ...
          <Paper elevation={4} sx={{
            ...
            <CardActionArea>
              <CardMedia
                ...
                style={{
                  backgroundImage:
                    "url(https://i0.wp.com/www.giveindia.org/blog/wp-content/uploads/2021/02/e-1024x677.jpg?resize=696%2C460&ssl=1)",
                  backgroundSize: "cover",
                  borderTopLeftRadius: "8px",
                  borderTopRightRadius: "8px",
                  alt: "image",
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  <Typography>
                    <strong>.</strong>For Personal Fulfillment and Social Impact
                  </Typography>
                  <Typography>
                  ...
                  <Typography>
                    <strong>.</strong> Contributing to Long-Term Positive Change
                  </Typography>
                </Typography>
              </CardContent>
              <CardActions style={{ justifyContent: "center" }}>
